...
extension ReadingView {
    func saveProgress() {
        ...
        Task {
            ...
            // 保存到本地
            preferences.saveReadingProgress(bookUrl: bookUrl, chapterIndex: chapterIdx, pageIndex: 0, bodyCharIndex: Int(pos * 10000), timestamp: Int(Date().timeIntervalSince1970 * 1000))
            // 保存到服务器
